...
Each instance of the dataset is composed of specific features which are represented
in JSON format. The descriptors are described at the following link and are called
the low-level data:

* [Music Descriptors](https://essentia.upf.edu/streaming_extractor_music.html#music-descriptors)
